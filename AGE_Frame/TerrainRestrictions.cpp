...
void AGE_Frame::CreateTerrainRestrictionControls()
{
    ...
    TerRestrict_Graphics_Text[0] = new SolidText(Tab_TerrainRestrictions, " Exit Tile Sprite");
    TerRestrict_Graphics_Text[1] = new SolidText(Tab_TerrainRestrictions, " Enter Tile Sprite");
    TerRestrict_Graphics_Text[2] = new SolidText(Tab_TerrainRestrictions, " Walk Tile Sprite");
